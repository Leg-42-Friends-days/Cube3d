...
/*   Updated: 2026/05/20 17:48:32 by ibrouin-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_drunk(t_global *global, long current_time)
{
...
void	drink_beer(t_global *global, long current_time)
{
	...
	playerxx = global->raycast_data.player.x
		+ (global->raycast_data.dir.x * 0.8);
	playeryy = global->raycast_data.player.y
		+ (global->raycast_data.dir.y * 0.8);
	...
	if (global->map.mapou[(int)playeryy][(int)playerxx])
	{
		...
		{
			update_drunk(global, current_time);
